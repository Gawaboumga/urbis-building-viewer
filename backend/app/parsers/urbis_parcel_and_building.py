    ...
    with Session(engine) as session:
        ...
        for gpkg_address in results:
            ...
            address = Address(
                ...
                street_id=street_id,
                municipality_id=municipality_id,
                parent_id=read_inspire_id(gpkg_address.parent_id, InspireBaseURI.ADDRESS) if gpkg_address.parent_id else None,
                cadastral_parcel_id=cadastral_parcel_id,
                building_id=read_inspire_id(gpkg_address.bu_id, InspireBaseURI.BUILDING) if gpkg_address.bu_id else None,
    ...
    with Session(engine) as session:
        ...
        for gpkg_building in results:
            ...
            building = Building(
                ...
                block_id=read_inspire_id(gpkg_building.block_id, InspireBaseURI.BLOCK) if gpkg_building.block_id else None,
    ...
    with Session(engine) as session:
        ...
        for gpkg_cadastral_parcel in results:
            ...
            cadastral_parcel = CadastralParcel(
                ...
                municipality_id=int(gpkg_cadastral_parcel.munnis_code) if gpkg_cadastral_parcel.munnis_code else None,
